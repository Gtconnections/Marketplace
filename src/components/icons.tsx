/**
 * Iconos SVG de línea (estilo Lucide), currentColor. Reemplazan emojis.
 * Todos son decorativos por defecto (aria-hidden); si un icono es la única
 * etiqueta de un control, el control debe llevar su propio aria-label.
 */
...
/** Estrella rellena (usa fill=currentColor). Para ratings. */
